...
// Adaptacoes em relacao ao original do unlumen-ui:
// - importa de "motion/react" (mesmo pacote dos outros componentes) em vez de "framer-motion"
// - usa CaretDown do Phosphor no lugar do ChevronDownIcon do lucide (uma familia de icones so)
  ...
  return (
    <HighlightItem asChild>
      ...
      >
        ...
        >
          <CaretDownIcon className="size-3.5" weight="bold" aria-hidden="true" />
        </motion.span>
      </button>
    </HighlightItem>
  );
